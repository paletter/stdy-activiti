...
public class AuditContract3 {
	...
	public static void main(String[] args) throws Throwable {
		...
		rs.createDeployment().addClasspathResource("AuditContract2.bpmn").deploy();
...
//		createPng(processEngine, processInstance, cfg);
		
		convert(processInstance);
